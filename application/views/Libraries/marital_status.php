...
<div id="maritalStatus">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title d-inline">Social Pension Marital Status</h3>
                    <button class="btn btn-primary float-right" data-toggle="modal" data-target="#addMsModal">Add New Marital Status</button>
                </div>
                <div class="card-body">
                    <v-client-table :columns="table.columns" :data="table.data.list" :options="table.options">
                        ...
                        <template slot="action" slot-scope="props">
                            <button type="button" class="btn btn-warning btn-sm" @click="updateMaritalStatus(props.row)" data-toggle="modal" data-target="#updateMsModal"><i class="fa fa-edit"></i></button>
    ...
    <!-- ADD -->
    <div class="modal" id="addMsModal" tabindex="-1" role="dialog">
   ...
   <!--  UPDATE -->
    <div class="modal" id="updateMsModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <form v-on:submit.prevent="update_marital_status_form">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Update Marital Status</h5>
                        <a href="#" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </a>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col -md-12">
                                <label for="">Marital Status Status</label>
