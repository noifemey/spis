...
<table class="tg" style="width: 100%; table-layout: fixed;" cellpadding="0">
  ...
  <tr>
    <td class="tg-4vfs" height="25" colspan="18">Cardholder's Name (Applicable only for Gift Card purchased by an Institutional Customer):<br><div style="text-align:left; font-weight:bold; font-size:16px;">.<br></td>
    <td class="tg-4vfs" height="25" colspan="4" rowspan="4"></td>
  </tr>
  <tr>
    <td class="tg-4vfs" height="20" colspan="15">Permanent Address:<br><div style="font-weight:bold; font-size:12px;"></div></td>
    <td class="tg-4vfs" height="20" colspan="3">Zip Code:<br><div style="text-align:left; font-weight:bold; font-size:12px;">.</div></td>
  </tr>
  <tr>
    <td class="tg-4vfs" height="20" colspan="15">Present Address:<br><div style="font-weight:bold; font-size:12px;"></div></td>
    <td class="tg-4vfs" height="20" colspan="3">Zip Code:<br/><div style="text-align:left; font-weight:bold; font-size:12px;">.</div></td>
  </tr>
  <tr>
    <td class="tg-c3ow" height="20" colspan="4">Place of Birth:<br><div style="font-weight:bold; font-size:12px;"></div></td>
    <td class="tg-c3ow" height="20" colspan="4">Date of Birth:<br><div style="font-weight:bold; font-size:12px;"></div></td>
    <td class="tg-c3ow" height="20" colspan="4">Nationality: <br/><div style="font-weight:bold; font-size:12px;">	FILIPINO / 608 </div></td>
    <td class="tg-c3ow" height="20" colspan="6">Mother's Maiden Name:<br/><div style="font-weight:bold; font-size:12px;"></div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="tg-c3ow" height="20" colspan="11">Cardholder's Name:<br><div style="font-weight:bold; font-size:14px;"></div></td>
    <td class="tg-c3ow" height="20" colspan="4">Contact Number/s:<br><div style="font-weight:bold; font-size:12px;"></div></td>
    <td class="tg-c3ow" height="20" colspan="7">Date of Birth:<br><div style="font-weight:bold; font-size:12px;"></div></td>
  </tr>
  <tr>
    <td class="tg-c3ow" height="20" colspan="11">Permanent Address:<br><div style="font-weight:bold; font-size:9px;"></div></td>
    <td class="tg-c3ow" height="20" colspan="4">Zip Code:<br/><div style="font-weight:bold; font-size:12px;">.</div></td>
    <td class="tg-c3ow" height="20" colspan="7" rowspan="2">Relationship with the Purchaser:</td>
  </tr>
  <tr>
    <td class="tg-c3ow" height="20" colspan="11">Present Address:<br><div style="font-weight:bold; font-size:9px;"></div></td>
    <td class="tg-c3ow" height="20" colspan="4">Zip Code:<br/><div style="font-weight:bold; font-size:12px;">.</div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="tg-6yth" height="15"><div style="font-weight:bold; font-size:12px;">.</div></td>
    <td class="tg-6yth" height="15"><div style="font-weight:bold; font-size:12px;"></div></td>
    <td class="tg-6yth" height="15"><div style="font-weight:bold; font-size:12px;"></div></td>
    <td class="tg-6yth" height="15"><div style="font-weight:bold; font-size:12px;"></div></td>
    <td class="tg-6yth" height="15"><div style="font-weight:bold; font-size:12px;"></div></td>
  ...
  <tr>
    ...
    <br><u style="font-weight:bold; font-size:12px;"></u><br/>Signature Over Printed Name<br>of Purchaser/ Applicant / Authorized Signatory<br>
    </div>
  ...
  <tr>
    ...
    <td  height="20" style="text-align:center;" class="tg-0lax" colspan="6">Card/PIN Mailer Received by:<br><br><u><div style="font-weight:bold; font-size:10px;"></div></u>Signature Over Printed Name<br>of Purchaser/Cardholder<br></td>
  </tr>
  <tr>
...
<table style="background-color: #000; width:100%; font-size:12px; font-family:Arial, sans-serif;" cellpadding="5">
    ...
    <tr style="background-color: #fff;">
      <td colspan=2> Name:<br/><b></b><br/> </td>
