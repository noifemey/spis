		...
		data: {
			...
			exportCE(){
				...
				if(app.search.prov_code == "" || app.search.year == ""){
					...
					var urls = window.App.baseUrl +"export-ce-active?prov_code="+app.search.prov_code+"&mun_code="+app.search.mun_code+"&year="+app.search.year+"&period="+app.search.period+"&liquidation="+app.search.liquidation+"&type="+app.search.type;
			...
			exportUnpaidCE(){
				if(app.search.prov_code == "" || app.search.year == "" || app.search.period == ""){
					...
					var urls = window.App.baseUrl +"Payroll/exportReplacement?prov_code="+app.search.prov_code+"&mun_code="+app.search.mun_code+"&year="+app.search.year+"&period="+app.search.period+"&liquidation="+app.search.liquidation+"&type="+app.search.type;
					window.open(urls, '_blank');
				}
			},
			generateCAP(){
				app.search.unpaid = false;
				if(app.search.prov_code == "" || app.search.mun_code == "" || app.search.year == "" || app.search.period == ""){
					swal.fire('Error',"Please Enter Required Fields[Province, Municipality, Year , Period]",'error');
				}else{
					var urls = window.App.baseUrl +"generate-cap-active?prov_code="+app.search.prov_code+"&mun_code="+app.search.mun_code+"&year="+app.search.year+"&period="+app.search.period+"&liquidation="+app.search.liquidation+"&unpaid="+app.search.unpaid+"&type="+app.search.type;
					window.open(urls, '_blank');
				}
			},
			generateCAPUnpaid(){
				...
				if(app.search.prov_code == "" || app.search.mun_code == "" || app.search.year == "" || app.search.period == ""){
					...
					var urls = window.App.baseUrl +"Payroll/generateUnpaidCAP?prov_code="+app.search.prov_code+"&mun_code="+app.search.mun_code+"&year="+app.search.year+"&period="+app.search.period+"&liquidation="+app.search.liquidation+"&unpaid="+app.search.unpaid+"&type="+app.search.type;
